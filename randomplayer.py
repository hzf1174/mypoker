...
class RandomPlayer(BasePokerPlayer):
    ...
    def learn(self):
        ...
        fileObjectStackHistory = open('StackHistroy1.json', 'w')
        fileObjectStrategy = open('Strategy1.json', 'w')
        fileObjectCF = open('CF1.json', 'w')
        fileObjectRegret = open('Regret1.json', 'w')
        fileObjectSum = open('Sum1.json', 'w')
